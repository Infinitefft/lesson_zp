...
- OpenClaw  养虾
  一人公司
    虚拟数字人，多 Agent
    编程Agent（cursor），ptt，算账的，市场分析...
    任务拆解、计划，找到一批需要的Agent 完成任务。
    Manus
    OpenClaw 是开源版本的 Manus
- seedance 抖音的视频数据
...
## Agent 是什么？
其实就是给大模型扩展了Tool和Memory，他本来就可以思考、规划，他给你用tool扩展了能力，他就可以**自动**做事情，用memory 管理记忆，他就可以记住你想它记住的东西，还可以使用RAG查询内部知识来获取知识（context）
